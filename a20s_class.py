...
J3dict = {'242': [2,4,2], '424': [4,2,4], '246': [2,4,6], '642': [6,4,2], '426': [4,2,6], '624': [6,2,4], '264': [2,6,4],
          '462': [4,6,2], '626': [6,2,6], '662': [6,6,2], '266': [2,6,6], '248': [2,4,8], '842': [8,4,2], 
          '2,10,2': [2,10,2], '646': [6,4,6], '24,12': [2,4,12], '12,42': [12,4,2], '468': [4,6,8], '864': [8,6,4], 
          '486': [4,8,6], '684': [6,8,4], '2,10,6': [2,10,6], '6,10,2': [6,10,2], '666': [6,6,6], '686': [6,8,6],
          '12,12,12': [12,12,12], '12,18,12': [12,18,12], '18,18,18': [18,18,18], 
          '30,30,30': [30,30,30], '42,42,42': [42,42,42]}

J5dict = {'42424': [4,2,4,2,4], '2,10,2,10,2': [2,10,2,10,2], '2468,10': [2,4,6,8,10], '10,8642': [10,8,6,4,2], '66266': [6,6,2,6,6], 
          '6,12,2,6,12': [6,12,2,6,12], '12,6,2,12,6': [12,6,2,12,6], '64,14,42': [6,4,14,4,2], '24,14,46': [2,4,14,4,6],
          '6,12,10,66': [6,12,10,6,6], '66,10,12,6': [6,6,10,12,6], '10,2,10,2,10': [10,2,10,2,10], '6,14,10,66': [6,14,10,6,6],
          '66,10,14,6': [6,6,10,14,6], '6,14,10,68': [6,14,10,6,8], '86,10,14,6': [8,6,10,14,6],
          '10,20,10,20,10': [10,20,10,20,10], '30,30,30,30,30': [30,30,30,30,30]}

# key arrays for consistent indexing of the keys, e.g. for legends and for DH 2d arrays
J3keyarr = ['242', '426', '624', '24,12', '12,42', '626', '662', '266', '248', '842', '486', '684', '424', '264', '462', '246', '642',
            '2,10,6', '6,10,2', '666', '2,10,2', '468', '864', '12,12,12', '18,18,18', '686', '42,42,42', '12,18,12', '30,30,30']

J5keyarr = ['42424', '2,10,2,10,2', '64,14,42', '24,14,46', '66266', '6,12,2,6,12', '12,6,2,12,6', '6,12,10,66', '66,10,12,6',
            '2468,10', '10,8642', '10,2,10,2,10', '6,14,10,66', '66,10,14,6', '6,14,10,68', '86,10,14,6', '10,20,10,20,10', '30,30,30,30,30']
